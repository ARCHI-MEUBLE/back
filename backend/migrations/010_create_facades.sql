...
INSERT INTO facade_materials (name, color_hex, texture_url, price_modifier, is_active) VALUES
    ('Chêne Naturel', '#D8C7A1', '/textures/chene-naturel.jpg', 0, TRUE),
    ('Chêne Foncé', '#8B7355', '/textures/chene-fonce.jpg', 10, TRUE),
    ('Blanc Mat', '#FFFFFF', NULL, -5, TRUE),
    ('Noir Mat', '#1A1917', NULL, 5, TRUE),
    ('Gris Anthracite', '#4A4A4A', NULL, 0, TRUE),
    ('Bleu Pastel', '#A8C5DD', NULL, 15, TRUE),
    ('Vert Sauge', '#9CAF88', NULL, 15, TRUE);
...
INSERT INTO facade_drilling_types (name, description, icon_svg, price, is_active) VALUES
    ('Poignée Ronde', 'Perçage circulaire pour poignée ronde', '<circle cx="12" cy="12" r="5"/>', 5, TRUE),
    ('Poignée Longue', 'Perçage horizontal pour poignée longue', '<rect x="5" y="10" width="14" height="4" rx="2"/>', 7, TRUE),
    ('Serrure', 'Perçage pour serrure avec cylindre', '<circle cx="12" cy="12" r="3"/><rect x="10" y="15" width="4" height="5"/>', 15, TRUE),
    ('Passage de Câble', 'Perçage circulaire pour passage de câble', '<circle cx="12" cy="12" r="4" stroke-dasharray="2,2"/>', 3, TRUE),
    ('Aération', 'Grille d''aération', '<rect x="6" y="8" width="12" height="8" fill="none" stroke="currentColor"/><line x1="6" y1="10" x2="18" y2="10"/><line x1="6" y1="12" x2="18" y2="12"/><line x1="6" y1="14" x2="18" y2="14"/>', 8, TRUE);
