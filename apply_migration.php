<?php
/**
 * Script pour appliquer la migration des échantillons en local
 */

$dbPath = __DIR__ . '/backend/database/archimeuble.db';
$migrationPath = __DIR__ . '/backend/database/migrations/create_sample_orders.sql';

echo "🚀 Application de la migration échantillons...\n";
